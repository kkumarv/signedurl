...
//  }
  ...
  public void goodResult1() throws Exception {
    ...
    msgCtxt.setVariable("request.content", "{ \"bucket\": \"something\", \"resources\": [ \"test23\", \"test34\" ] }");
   // msgCtxt.setVariable("bucket", "samplebucket");
  ...
  //  String tooo = (String) msgCtxt.getVariable("tada");
//   
...
//    props.put("tada", "tofdo");
//
//    V4SignedUrlCallout callout = new V4SignedUrlCallout(props);
////    
//    String kk= msgCtxt.getVariable("tada");
